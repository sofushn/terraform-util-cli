...
If the namespace is omitted, the CLI should search and select the best match. For common official providers this usually resolves to `hashicorp/<name>`, but the CLI should confirm against registry data instead of hardcoding.
